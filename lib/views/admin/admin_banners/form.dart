...
class AdminBannerForm extends StatefulWidget {
  final Map<String, dynamic>? banner;
  const AdminBannerForm({Key? key, this.banner}) : super(key: key);

  @override
  State<AdminBannerForm> createState() => _AdminBannerFormState();
}
...
class _AdminBannerFormState extends State<AdminBannerForm> {
  ...
  bool _validateCurrentStep() {
    switch (_currentStep) {
      case 0: // Basic Info step
        ...
        if (_subtitleController.text.isEmpty) return false;
        return true;
      case 1: // Image step
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    Colors.transparent,
                    const Color(0xFF2C8610).withOpacity(0.3),
                    Colors.transparent,
                  ],
                ),
              ),
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: const BorderSide(color: Color(0xFF2C8610)),
        ),
        filled: true,
  ...
  Widget _buildActionSettingsStep() {
    return _buildSectionCard(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(12),
              border: Border.all(
                color: const Color(0xFF2C8610).withOpacity(0.3),
              ),
            ),
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Lower numbers appear first. Order 0 will be displayed at the top.',
                    style: TextStyle(
                      color: const Color(0xFF2C8610),
                      fontSize: 14,
                    ),
  ...
  Future<void> _saveBanner() async {
    ...
    try {
      if (widget.banner == null) {
        ...
        await FirestoreService.updateBanner(widget.banner!['id'], data);
      }
  ...
  Widget build(BuildContext context) {
    List<Step> steps = [
      ...
      Step(
        ...
        content: _buildActionSettingsStep(),
        ...
        body: Container(
          ...
          child: Form(
            ...
            child: Stepper(
              ...
              onStepContinue:
                  _currentStep == steps.length - 1 ? _saveBanner : _nextStep,
